...
func New(ctx context.Context, pid int64, claims *jwttoken.Claims, resource *resources.Resources) (*Player, error) {
...
func (p *Player) Handler(in []byte) (res []byte, err error) {
	...
	default:
		code, res, err = p.resources.Handler(p.claims.Username, req)
	}
