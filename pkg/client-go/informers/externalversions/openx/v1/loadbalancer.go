	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.OpenxV1().LoadBalancers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenxV1().LoadBalancers(namespace).Watch(context.TODO(), options)
			},
		},
		&openxv1.LoadBalancer{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *loadBalancerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&openxv1.LoadBalancer{}, f.defaultInformer)
}
