	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.OpenxV1().Mysqls(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenxV1().Mysqls(namespace).Watch(context.TODO(), options)
			},
		},
		&openxv1.Mysql{},
		resyncPeriod,
...
func (f *mysqlInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&openxv1.Mysql{}, f.defaultInformer)
}
