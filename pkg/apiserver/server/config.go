...
import (
	...
	"github.com/kzz45/neverdown/pkg/apiserver/endpoints/discovery"
	genericregistry "github.com/kzz45/neverdown/pkg/apiserver/registry/generic"
...
func DefaultBuildHandlerChain(apiHandler http.Handler, c *Config) http.Handler {
	...
	apiHandler = genericfilters.WithWaitGroup(apiHandler, c.LongRunningFunc, c.NonLongRunningRequestWaitGroup)
	...
	apiHandler = genericapifilters.WithRequestInfo(apiHandler, c.RequestInfoResolver)
