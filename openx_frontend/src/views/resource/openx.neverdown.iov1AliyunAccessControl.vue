<template>
  ...
  <div class="menu-item" v-show="activeIndex === '2'">
    <div class="spec-item">
      <div class="spec-label">instance</div>
      <div class="spec-value">
        <div style="display: flex">
          <el-input
            v-model="props.itemInfo.spec.instance.key"
            placeholder="key"
            size="small"
          />
          <div class="middle-dash">:</div>
          <el-input
            v-model="props.itemInfo.spec.instance.value"
            placeholder="value"
            size="small"
          />
        </div>
    ...
    <div class="spec-item">
      ...
      <div class="spec-value">
        <div style="display: flex">
          <el-input
            v-model="props.itemInfo.spec.status.key"
            placeholder="key"
            size="small"
          />
          <div class="middle-dash">:</div>
          <el-input
            v-model="props.itemInfo.spec.status.value"
            placeholder="value"
            size="small"
          />
        </div>
    ...
    <div class="spec-item">
      ...
      <div class="spec-value">
        <div style="display: flex">
          <el-input
            v-model="props.itemInfo.spec.type.key"
            placeholder="key"
            size="small"
          />
          <div class="middle-dash">:</div>
          <el-input
            v-model="props.itemInfo.spec.type.value"
            placeholder="value"
            size="small"
          />
        </div>
