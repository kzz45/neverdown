...
var ErrNotInCluster = errors.New("unable to load in-cluster configuration, DISCOVERY_SERVICE_HOST and DISCOVERY_SERVICE_PORT must be defined")
var ErrCAFileNotInCluster = errors.New("unable to load in-cluster configuration, DISCOVERY_SERVICE_CAFILE must be defined")
