...
func newRepositories(c *JingxV1Client, namespace string) *repositories {
	return &repositories{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *repositories) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.Repository, err error) {
...
func (c *repositories) List(ctx context.Context, opts metav1.ListOptions) (result *v1.RepositoryList, err error) {
...
func (c *repositories) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *repositories) Create(ctx context.Context, repository *v1.Repository, opts metav1.CreateOptions) (result *v1.Repository, err error) {
	result = &v1.Repository{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("repositories").
...
func (c *repositories) Update(ctx context.Context, repository *v1.Repository, opts metav1.UpdateOptions) (result *v1.Repository, err error) {
	result = &v1.Repository{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("repositories").
...
func (c *repositories) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *repositories) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *repositories) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.Repository, err error) {
	result = &v1.Repository{}
